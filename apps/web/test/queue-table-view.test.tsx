...
const BARE_TABLE_OK: Record<string, string> = {
  ...
  "screens/ApprovalsRegister.tsx": "not yet migrated — an unbounded register (audit H3)",
  "screens/CaseManager.tsx": "not yet migrated — three unbounded queues (audit H3)",
  "screens/FinancePortal.tsx": "not yet migrated — utilization and settlements (audit H3)",
  "screens/Notifications.tsx": "not yet migrated — the inbox (audit H3)",
  "screens/PractitionerAdmin.tsx": "not yet migrated — the clinician roster (audit H3)",
  "screens/BranchLicences.tsx": "not yet migrated — rosters and alert lists (audit H3)",
  "screens/ProcedureCentre.tsx": "not yet migrated — the delivery queue (audit H3)",
  "screens/ReceptionDashboard.tsx": "not yet migrated — the day's visits (audit H3)",
  "screens/NetworkTierAdmin.tsx": "not yet migrated — tier assignments (audit H3)",
