...
> the ETag/If-Match opt-in it gated). **17.1 DONE** (identity-service: Identity store + roles/scopes as data,
> 6/6 real-PG tests). **Next: Phase 17.2** (OpenIddict issuer — PKCE/CC/refresh, frozen claims).
