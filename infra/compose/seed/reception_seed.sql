...
INSERT INTO eligibility.member_projection
  (beneficiary_id, member_no, given_name, family_name, status, primary_phone, national_id, passport, refugee_id, unhcr_no, updated_at)
VALUES
  ('a1000000-0000-4000-8000-000000000001', 'MRS-M-100001', 'Amina',   'Hassan',  'Active',    '01000000001', '29001010100011', 'P1234561', 'REF-100001', 'UNHCR-100001', now()),
  ('a1000000-0000-4000-8000-000000000002', 'MRS-M-100002', 'Omar',    'Khalil',  'Active',    '01000000002', '29102020200022', 'P1234562', 'REF-100002', 'UNHCR-100002', now()),
  ('a1000000-0000-4000-8000-000000000003', 'MRS-M-100003', 'Layla',   'Ahmed',   'Suspended', '01000000003', '29203030300033', 'P1234563', 'REF-100003', 'UNHCR-100003', now()),
  ('a1000000-0000-4000-8000-000000000004', 'MRS-M-100004', 'Youssef', 'Ibrahim', 'Active',    '01000000004', '29304040400044', 'P1234564', 'REF-100004', 'UNHCR-100004', now())
ON CONFLICT (beneficiary_id) DO UPDATE SET
  member_no = EXCLUDED.member_no, given_name = EXCLUDED.given_name, family_name = EXCLUDED.family_name,
